...
public class ClanFile {
	...
	public static void loadClan() {
		...
		File file = new File("plugins//ServerSystem//Clan//ClanConfig.yml");
		...
		config.addDefault("message.Clan Einladung nicht angenommen",
				"&7Der Spieler &e%player& &7hat die &cClan &7Anfrage abgelehnt&8.");
		...
		config.addDefault("message.clan Einladung erhalten",
				"&7Du hast eine Einladung zum Clan &e%clan% &7erhalten&8.");
		...
		config.addDefault("message.Spieler in Clan beigetreten",
				"&7Der Spieler &e%player% &7ist dem Clan beigetreten&8.");
