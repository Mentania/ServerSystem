...
public class FileManagaerKit {
	...
	private static FileWriter file = new FileWriter(ServerSystem.getInctance().getDataFolder().getPath(),
			"StarterKit.yml");
	...
	public static void relaodFile() {
		file = new FileWriter(ServerSystem.getInctance().getDataFolder().getPath(), "StarterKit.yml");
		readFile();
	}
