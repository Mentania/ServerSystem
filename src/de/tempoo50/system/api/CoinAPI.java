...
import de.tempoo50.system.mysql.MySQL;
...
public class CoinAPI implements Economy {
	...
	public String currencyNameSingular() {
		...
		return (String) e.get("Eco.Single");
	}
	...
	public EconomyResponse depositPlayer(OfflinePlayer arg0, double arg1) {
		EconomyResponse result = new EconomyResponse(arg1, -1, ResponseType.FAILURE,
		...
		try {
			...
			if(arg1 <= 0) {
				return new EconomyResponse(arg1, -1, ResponseType.FAILURE, "Es sind nur positive Werte erlaubt!");
			}
	...
	public EconomyResponse withdrawPlayer(OfflinePlayer arg0, double arg1) {
		...
		try {
			...
			if (arg1 <= 0) {			
				return new EconomyResponse(arg1, -1, ResponseType.FAILURE, "Der Wert muss positiv sein!");			
			}
