		...
		if (!isConnected()) {
			try {
				connection = DriverManager.getConnection(
						"jdbc:mysql://" + DataChest.MySQLHost + ":" + DataChest.MySQLPort + "/"
								+ DataChest.MySQLDatabase + "?autoReconnect=true",
						DataChest.MySQLUser, DataChest.MySQLPassword);
